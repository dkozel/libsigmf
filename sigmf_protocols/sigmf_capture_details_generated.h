...
struct Capture FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<double>(verifier, VT_ACQ_SCALE_FACTOR, 8) &&
           VerifyField<double>(verifier, VT_ATTENUATION, 8) &&
           VerifyField<double>(verifier, VT_ACQUISITION_BANDWIDTH, 8) &&
...
struct Annotation FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<double>(verifier, VT_SNRDB, 8) &&
           VerifyField<uint64_t>(verifier, VT_SIGNAL_REFERENCE_NUMBER, 8) &&
           verifier.EndTable();
  }
...
inline DescrT::DescrT(const DescrT &o)
      : global((o.global) ? new sigmf::capture_details::GlobalT(*o.global) : nullptr),
        annotation((o.annotation) ? new sigmf::capture_details::AnnotationT(*o.annotation) : nullptr),
        capture((o.capture) ? new sigmf::capture_details::CaptureT(*o.capture) : nullptr) {
}
...
inline void Descr::UnPackTo(DescrT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = global(); if (_e) { if(_o->global) { _e->UnPackTo(_o->global.get(), _resolver); } else { _o->global = std::shared_ptr<sigmf::capture_details::GlobalT>(_e->UnPack(_resolver)); } } else if (_o->global) { _o->global.reset(); } }
  { auto _e = annotation(); if (_e) { if(_o->annotation) { _e->UnPackTo(_o->annotation.get(), _resolver); } else { _o->annotation = std::shared_ptr<sigmf::capture_details::AnnotationT>(_e->UnPack(_resolver)); } } else if (_o->annotation) { _o->annotation.reset(); } }
  { auto _e = capture(); if (_e) { if(_o->capture) { _e->UnPackTo(_o->capture.get(), _resolver); } else { _o->capture = std::shared_ptr<sigmf::capture_details::CaptureT>(_e->UnPack(_resolver)); } } else if (_o->capture) { _o->capture.reset(); } }
}
